...
useEffect(()=>{
  ...
  const response=await axios.get(`https://internarea-backend-jbx2.onrender.com/api/internship/${id}`)
...
const submitApplication= async()=>{
  const text=document.getElementById("text")
    if (text.value==="") {
      ...
      await axios.post("https://internarea-backend-jbx2.onrender.com/api/application",bodyJson).then((res)=>{
